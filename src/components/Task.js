...
function Task(props) {
        ...
        .then((res) => {
          ...
          res.data.map((val, index) => {
            if (val.projectId === props.id) {
              ...
              //     [uuid()]: {
              //         name: "Requested",
              //         items: val.description.filter((task) => task.stage === "Requested").sort((a, b) => {
              //             return a.order - b.order;
              //         })
              //     },
              //     [uuid()]: {
              //         name: "To do",
              //         items: val.description.filter((task) => task.stage === "To do").sort((a, b) => {
              //             return a.order - b.order;
              //         })
              //     },
              //     [uuid()]: {
              //         name: "In Progress",
              //         items: val.description.filter((task) => task.stage === "In Progress").sort((a, b) => {
              //             return a.order - b.order;
              //         })
              //     },
              //     [uuid()]: {
              //         name: "Done",
              //         items: val.description.filter((task) => task.stage === "Done").sort((a, b) => {
              //             return a.order - b.order;
              //         })
              // }
  ...
  return (
    ...
    //         <BtnPrimary onClick={() => setAddTaskModal(true, { projectId })}>
    //             Add todo
    //         </BtnPrimary>
    //     </div>
    //     <DragDropContext
    ...
    <div className="px-12 py-6 w-full">
      ...
      >
      {/* <DropdownMenu taskId={taskId}  projectId={props.prid} setRenderChange={isRenderChange}  /> */}
      {/* {expand?(<><DropdownMenu taskId={taskId}  projectId={props.prid} setRenderChange={isRenderChange}  /></>):(null)} */}
